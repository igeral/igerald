    ...
    n.extend(p.prototype, {
        ...
        if (!(p.isDragging || p.isClosing || (p.isAnimating && p.firstRun))) {
          ...
          if (
            ...
            if (
              ...
              (r.isMoved =
                (0 !== u.left || 0 !== u.top) &&
                !r.$slide.hasClass("fancybox-hasEffect")),
              (r.forcedDuration = o),
              n.isNumeric(e)
                ? (r.forcedDuration = e)
          ...
          "zoom" === e
            ...
            : (c.updateSlide(t),
              e
                ? (n.fancybox.stop(l),
                  (i =
                    "fancybox-hasEffect fancybox-slide--" +
          ...
          l.trigger("beforeClose", t) === !1
            ...
            : (l.removeEvents(),
              ...
              p.$slide
                .off(d)
                .removeClass(
                  "fancybox-slide--complete fancybox-slide--next fancybox-slide--previous fancybox-hasEffect"
                ),
                ...
                : (o && i
                    ? t === !0
                      ...
                      : n.fancybox.animate(
                          ...
                          "fancybox-hasEffect fancybox-slide--previous fancybox-fx-" +
                            o,
                          i,
                          h
                        )
      ...
      cleanUp: function (t) {
        ...
        a.current.$slide.trigger("onReset"),
          ...
          o
            ? o.activate()
            : (s.scrollTop(a.scrollTop).Left(a.scrollLeft),
      ...
      (u.prototype.ontouchstart = function (o) {
        ...
        if (
          ...
          if (((i.realPoints = i.startPoints = a(o)), i.startPoints)) {
            ...
            (n.fancybox.mobileView && (l(c) || l(c.parent()))) ||
              o.preventDefault(),
        ...
        e.$refs.stage.on(
          ...
          function (t) {
            ...
            e.group.length < 1 ||
              ...
              (t.preventDefault(),
              t.stopPropagation(),
              o.$slide.hasClass("fancybox-hasEffect") ||
                ((t = t.originalEvent || t),
                i - n < 250 ||
                  ((n = i),
                  e[
