/*! jQuery v1.12.4 | (c) jQuery Foundation | jquery.org/license */ !(function (
  ...
  (n.fn.load = function (a, b, c) {
    ...
    (n.expr.filters.hasEffect = function (a) {
...
$(document).ready(function () {
  ...
  $(".sp-row-grid").imagesLoaded({}, function () {
    $(".sp-row-grid").masonry({
      itemSelector: ".sp-row-grid-item",
      columnWidth: ".sp-row-grid-sizer",
...
$("#store-form").on("submit", function ($e) {
  ...
  if ($(this).is($("#newsletter-subscription"))) {
    var $formBlock = $("#newsletter-subscription").parent(".sec-12-xs");
    ...
    if ($(this).is($("#contact-form"))) {
      var $formBlock = $("#contact-form").parent(".sec-12-xs");
      ...
      var $formBlock = $("#store-form").closest("div.sec-12-xs");
...
$(document).ready(function () {
  ...
  if ($(window).width() < 768) {
    $(".nd-compo-popup").each(function () {
      if (!$(this).hasClass("hidden-sec")) {
        $(this).addClass("hidden-sec");
      }
    });
  }
  if (!$(".nd-compo-popup").hasClass("hidden-sec")) {
  ...
  xhr = $.ajax({
    ...
    success: function (data) {
      ...
      $.each(results, function ($key, $value) {
        $resultsList.append(
          '<div class="sec-12-xs col-sm-6 sec-3-sm">\n' +
